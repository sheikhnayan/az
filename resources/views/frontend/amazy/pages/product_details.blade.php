                            ...
                            <div class="product_content_details mb_20">
                                ...
                                <div class="destils_prise_information_box mb_20">
                                    ...
                                    <h2 class="pro_details_prise d-flex align-items-center  m-0">
                                        <span>
                                            @if (str_replace('৳ ','',getProductDiscountedPrice($product)) > 0 )
                                            ...
                                            @php
                                                $cost = DB::table('seller_product_s_k_us')->where('product_id',$product->id)->first();
                                            @endphp
                                                ৳ {{ $cost->selling_price }}
                                            @endif
                                        </span>
                                        ...
                                        <div class="add_wish_compare d-flex alingn-items-center mb_20">
                                            ...
                                            @auth
                                                @if (Auth::user()->affiliate == 1)
                                                    <a id="affiliate" data-id="{{ $product->id }}" data-commission="{{ $product->affiliate }}" class="single_wish_compare text-uppercase text-nowrap cursor_pointer">
                                                        <i class="ti-control-shuffle"></i> Get Affiliate Link
                                                    </a>

                                                    <div class="modal affiliate" tabindex="-1" role="dialog">
                                                        <div class="modal-dialog" role="document">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                              <h3>Affilaite Commission for this product is {{ $product->affiliate }}</h3>

                                                              <label>Affiliate Link</label>
                                                              <input type="text" value="{{ Request::url() }}?affiliate={{ Auth::user()->id }}" class="form-control copy" id="copy" readonly>
                                                            </div>
...
<script>
    var myParam = location.search.split('affiliate=')[1] ? location.search.split('affiliate=')[1] : 'none';

    if (myParam != 'none') {

        $.ajax({
            url: "/amazcarts/set-affiliate/"+myParam,
            type: 'GET',
